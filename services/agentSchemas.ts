...
// Schéma sortie ContentWriter
export const ContentWriterOutputSchema = z.object({
  outline: z.array(z.string()), // H1/H2
...
export const SocialOutputSchema = z.object({
    scheduledPosts: z.array(z.object({
        ...
        visualSuggestion: z.string(),
        scheduledTime: z.string().datetime(), // Valide une date au format ISO 8601
    }))
});


// Schéma sortie Analytics
